...
\end{equation}
%todo: preguntar operadores/movimientos
...
En general, el algoritmo implementado está basado en el algoritmo Ant Colony System \cite{dorigo1997ant}. A continuación se muestra un pseudocógido del algoritmo \ref{alg}.\\
\begin{algorithm}[]
\label{alg}

 \KwData{Procedure ACS-TSP}
 inicializar\;
 \For{cada arco (i,j)}{
 	$\tau_{ij}(0) = \tau_{0}$
 }
